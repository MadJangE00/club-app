      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden">
        <div className="flex justify-between items-start p-4 border-b">
          <div className="flex items-center gap-3">
            ...
            {hasPrice && (
              <span className="px-2 py-1 bg-pink-100 text-pink-700 text-xs font-bold rounded-full">
                🛒 {photo.price}P
              </span>
            )}
          </div>
      ...
      {hasPrice ? (
        <div className="bg-white rounded-xl shadow p-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <PurchaseButton photoId={id} price={photo.price} sellerId={photo.user_id} />
          </div>
          <p className="text-sm text-gray-500">이 사진을 구매하면 고화질 원본을 볼 수 있습니다</p>
        </div>
      ) : (
        <div className="bg-white rounded-xl shadow p-6">
